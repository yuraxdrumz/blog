...
## Javascript - The Cons 
  ...
  3. The language changes so fast, I have seen legacy codebases with callbacks, later wrapped in promises and then awaited using the new async await syntax when new features were added.
