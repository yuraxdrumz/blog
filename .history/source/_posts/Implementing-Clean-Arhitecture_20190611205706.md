...
## Implementation
lets build a shopping cart, I know it is overused, but exactly for this reason I want to show how people couple their codebase to patterns/services/databases/implementations without even noticing, or the other way around, abstracting their way until its a nightmare to add/change something!
