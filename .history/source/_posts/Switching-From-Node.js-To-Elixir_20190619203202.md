...
In this post, I will highlight some of Javascript's pros and cons. Later on, I will set a list of must-have features I expect from a programming language, afterwards, I will explain why I chose `Elixir`. After listing Javascript's and Elixir's pros and cons, I will ask you a question - *Do the pros of X outweigh its cons*.
