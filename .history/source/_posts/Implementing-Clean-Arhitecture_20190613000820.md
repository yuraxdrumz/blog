...
## Entities
After deciding on our business rules (use-cases), we can create an inital data model. From the top of my head, we will need a cart type, product type and a user type.
