...
Lately, I have decided to find a new programming language as my daily driver to replace `Node.js`. It occured to me, that maybe a context switch, to a more strict and functional language, will teach me a thing or to and maybe do good for me and my team. The least we can do is try.
In this post, I will highlight some of Javascript's pros and cons. Later on, I will set a list of must-have features I expect from a programming language, afterwards, I will explain why I chose `Elixir`, what are its pros and cons and answer one question - *Do the pros of X outweigh its cons*.
