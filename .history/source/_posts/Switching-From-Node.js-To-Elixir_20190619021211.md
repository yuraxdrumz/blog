...
tags: 
  ...
  - Node.js
---
People often argue about language X being better/scalable/faster than language Y. After writing software for the past 6 years, I realized that the language does not matter as much as the  implementations that we write.
During my daily job, I mostly write in Node.js and lately, I have decided to find a new programming language as my daily driver. One of the reasons, being, that most Javascript code I encountered was either poorly written, barely documented or tangled and mentally exhausting. I tried to remediate the situation by using Typescript, but it occured to me, that maybe a context switch, to a more strict and functional language, will do good for me and my team. The least we can do is try, right?
