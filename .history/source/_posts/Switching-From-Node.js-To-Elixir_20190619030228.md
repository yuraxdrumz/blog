...
After having to deal with memory leaks and data being mutated wherever and whenever, I decided to tilt towards no. Encouraging developers to write in a particular way is good, but having the language strictly enforce something seems like a more viable option.
