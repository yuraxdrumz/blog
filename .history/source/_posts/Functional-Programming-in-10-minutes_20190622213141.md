...
```javascript
  /*
    ...
    // the above function in its curried form becomes:
  */
...
```
Note that there are different libraries in Javascript that allow automatic currying and purely functional languages curry by default, like `Haskell`
