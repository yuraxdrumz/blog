...
## Javascript - The Cons 
  ...
  6. The hybrid approach - The JS community advocates that it is great that you can write the same thing in a lot of ways, but in reality, not having a unified approach to writing code leads to worse codebases and repeated code.