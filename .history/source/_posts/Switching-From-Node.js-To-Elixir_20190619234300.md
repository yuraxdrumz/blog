...
tags: 
  ...
  - Node.js
---
After writing software for the past 6 years, I realized that the implementations that we write are far more important than the languages we choose, but, having a developer friendly, safe, strict language, can guide you towards better implementations. That is why I set to search for a new programming language, that will replace my daily driver - `Node.js`. 
