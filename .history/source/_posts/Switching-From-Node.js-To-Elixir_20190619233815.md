...
tags: 
  ...
  - Node.js
---
After writing software for the past 6 years, I realized that the implementations that we write are far more important than the languages we choose, but, that is true only to some extent. When people ask us about our main programming language, we often tend to tell the good parts, leaving the bad parts out. In a search for a new programming language, I asked myself two questions:
1. What are the must-have features I expect from a programming language?
2. Do its pros outweigh its cons?
