...
Due to these cons, I wrote the things I expect from a programming language and set out to search for it.
...
## What are some of the things I expect from a programming language
  ...
  2. Language syntax - I wanted a simple to understand syntax without drastic changes.
  ...
  6. Concurrent - I want something that allows concurrency with ease, without worrying about a single thread failing on me, or handling a threadpool and the accompanied mutexes/locks/deadlocks.
